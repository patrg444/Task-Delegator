...
async def main():
    ...
    print(f"Setting up GitHub repository...")
    try:
        project_info = await manager.setup_project(
            project_name,
            f"Collaborative development project: {project_name}"
        )
    ...
    print(f"2. Merge approved changes")
